    ...
    <section class="container-fluid">
      <section class="row">
        ...
        <article class="col-sm-10 col-md-10 menu" style="position: fixed; top: 0; left: 207px;">
          <span><a style="color:#04F3C4;" class="link link--kukuri" href="index.php" data-letters="HOME" onmouseover="playclip();">HOME</a></span>
          ...
          <div class="desktop">
              ...
              <a href="creator_catagory.php?cat_id=1">
                <article class="col-xs-6 col-sm-4 col-md-3 box_a" style="overflow:hidden;">
                  <div class="box_cate">
                    ...
                    <img id="db_application_ios" src="image_user/function/function_13550119_01.jpg" class="cat_profile">
                    <div class="box_count">
            ...
            <article class="col-xs-6 col-sm-4 col-md-3 box_b" style="overflow:hidden;">
              <div class="box_cate">
                ...
                <span class="cover_index"></span>
                <img id="db_application_web_mobile" src="image_user/avatar/avatar_13550185.jpg" class="cat_profile">
                <div class="box_count">
            ...
            <article class="col-xs-6 col-sm-4 col-md-3 box_a" style="overflow:hidden;">
              <div class="box_cate">
                ...
                <span class="cover_index"></span>
                <img id="db_application_android" src="image_user/function/function_13540644_01.jpg" class="cat_profile">
                <div class="box_count">
            ...
            <article class="col-xs-6 col-sm-4 col-md-3 box_b" style="overflow:hidden;">
              <div class="box_cate">
                ...
                <span class="cover_index"></span>
                <img id="db_application_tablet_interactive" src="image_user/avatar/avatar_13560171.jpg" class="cat_profile">
                <div class="box_count">
            ...
            <article class="col-xs-6 col-sm-4 col-md-3 box_b" style="overflow:hidden;">
              <div class="box_cate">
                ...
                <span class="cover_index"></span>
                <img id="db_application_arduino_interactive" src="image_user/avatar/avatar_13550137.jpg" class="cat_profile">
                <div class="box_count">
                  <p style="font-family: 'Titillium Web', sans-serif;">2 CREATOR</p>
                </div>
              </div>
            ...
            <article class="col-xs-6 col-sm-4 col-md-3 box_a" style="overflow:hidden;">
              <div class="box_cate">
                ...
                <span class="cover_index"></span>
                <img id="db_application_ios_interactive" src="image_user/function/function_13560098_01.jpg" class="cat_profile">
                <div class="box_count">
                  <p style="font-family: 'Titillium Web', sans-serif;">4 CREATOR</p>
                </div>
              </div>
            ...
            <article class="col-xs-6 col-sm-4 col-md-3 box_b" style="overflow:hidden;">
              <div class="box_cate">
                ...
                <span class="cover_index"></span>
                <img id="db_application_iot" src="image_user/avatar/avatar_13560178.jpg" class="cat_profile">
                <div class="box_count">
                  <p style="font-family: 'Titillium Web', sans-serif;">2 CREATOR</p>
                </div>
              </div>
          ...
          <div class="tablet">
            <article class="col-xs-12 col-sm-12 box_wrap_work">
              <div class="col-xs-6 col-sm-4 box-tableta box-mobilea">
                ...
                <span class="cover_index"></span>
                <img src="image_user/function/function_13560190_01.jpg" class="cat_profile">
                <div class="box_count">
          ...
          <article class="row">
            <article class="col-md-2">
              ...
              <article class="col-md-10 menu_r">
                ...
                <img src="banner/all.png" style="float:right; max-width: 40%; margin-bottom: 4%; margin-right: 4%;">
              </article>
              <!-- <section class="row"> -->
