...
$.getJSON("data/db_application_ios.json", function(data) {
...
$.getJSON("data/db_application_web_mobile.json", function(data) {
...
$.getJSON("data/db_application_android.json", function(data) {
...
$.getJSON("data/db_application_unity_kinect.json", function(data) {
